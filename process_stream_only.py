...
gasfles_dir = "data/detected_gasfles133"
false_neg_dir = "data/false_negatives_potentially133"
false_pos_dir = "data/false_positives_potentially133"
...
def process_videostream(video_source, is_stream=True):
    ...
    fps = cap.get(cv2.CAP_PROP_FPS) if is_stream else 25
...
if __name__ == "__main__":
    ...
    process_videostream(video_source, is_stream)
